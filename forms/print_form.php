...
class paperattendance_print_form extends moodleform {
	public function definition() {
		...
		$mform->addElement('html', '<div class="alert alert-info">Módulos por defecto vienen <strong>pre-checkeados</strong> desde omega para su curso actual y fecha seleccionada.</div>');
