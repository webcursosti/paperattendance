			        	...
			        	$.ajax({
			        	    ...
			        	    success: function (responsetwo) {
			        	        ...
			        	        //now we create the table with the students		        	        
			    				    ...
			    				    var table = '<table class="table table-hover table-condensed table-responsive table-striped" style="float:right; width:40%"><thead><tr><th>#</th><th><div style="display: block; margin-left: auto; margin-right: auto;"><input type="checkbox" id="checkAll">Asistencia</div></th><th>Alumno</th></tr></thead><tbody id="appendtrs">';
			    				    $("#inputs").append(table);
