...
echo "Start - line 74: ". memory_get_usage() . "\n";
...
if($resources = $DB->get_records_sql($sqlunreadpdfs, array())){
	...
	echo "$sqlunreadpdfs - line 85: ". memory_get_usage() . "\n";
	foreach($resources as $pdf){
		...
		echo "each pdf - line 91: ". memory_get_usage() . "\n";
 		...
 		if($process){
 			...
 			echo "pdf procesasdo correctamente - line 99: ". memory_get_usage() . "\n";
 		}
 		else{
 			mtrace("problem reading the csv or with the pdf");
 		}
	}
	echo "Fin foreach - line 105: ". memory_get_usage() . "\n";
...
echo "Fin CLI - line 119: ". memory_get_usage() . "\n";
